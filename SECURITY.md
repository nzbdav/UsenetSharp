...
certificate-chain and hostname validation while retaining TLS encryption.
It can permit a man-in-the-middle attack and should remain disabled unless
strict validation cannot be made to work.
